...
////  My_Resume
////
////  Created by Артём Тюрморезов on 08.08.2023.
////
//
//import Foundation
//import UIKit
...
//    lazy var collectionView = DynamicHeightCollectionView(frame: .zero, collectionViewLayout: createCompose())
//
...
//        descriptionLabel.textColor = MyResources.Colors.secondaryText
...
//        townLabel.textColor = MyResources.Colors.secondaryText
